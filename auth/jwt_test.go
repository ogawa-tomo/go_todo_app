...
import (
	...
	"github.com/ogawa-tomo/go_todo_app/testutil/fixture"
)
...
func TestJWTer_GetToken(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/ogawa-tomo/go_todo_app`).
	...
	req := httptest.NewRequest(http.MethodGet, `https://github.com/ogawa-tomo`, nil)
